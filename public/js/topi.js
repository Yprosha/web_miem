...
addButton.addEventListener('click', async () => {
    try {
        const response = await axios.get('/top-i/film/add');
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await axios.post('/api/top-i/film', {
                    place: placeValue,
                    name: nameValue,
...
async function loadFilm(pageNumber) {
    try {
        const response = await axios.get(`/api/top-i/film`, {params: {page: pageNumber}});
    ...
    infoBtns.forEach(infoBtn => {
        infoBtn.addEventListener('click', async () => {
            try {
                ...
                const response = await axios.get('/api/top-i/one-film', {params: {film_id: film_id}});
                ...
                btnSaveChanges.addEventListener('click', async (e) => {
                    ...
                    await axios.put('/api/top-i/film', {
                        id: film_id,
                        place: placeValue,
                        name: nameValue,
                        photo_link: photoLinkValue,
                ...
                btnDeleteMovie.addEventListener('click', async () => {
                    ...
                    await axios.delete(`/api/top-i/film/${film_id}`)
                        .then(response => {
